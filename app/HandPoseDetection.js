...
export default function HandPoseDetection() {
	...
	useEffect(() => {
		const handleZoom = () => {
			if (pinchStatus.left.isPinching && pinchStatus.right.isPinching) {
				const currentDistance = Math.hypot(
					fingersPosition.leftIndexTipPosX - fingersPosition.rightIndexTipPosX,
					fingersPosition.leftIndexTipPosY - fingersPosition.rightIndexTipPosY
				);
		...
		handleZoom();
	}, [pinchStatus, fingersPosition, zoomLevel, prevDistance]);
